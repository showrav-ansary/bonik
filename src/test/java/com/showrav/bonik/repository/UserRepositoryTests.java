...
import com.showrav.bonik.creator.UserCreator;
...
public class UserRepositoryTests {
    ...
    public void whenFindByIdAndNoUserThenReturnNull() {
        Assertions.assertThat(userRepository.findById(new Random().nextLong())).isNull();
    }

    @Test
    public void whenFindByUsernameAndNoUserThenReturnNull() {
        Assertions.assertThat(userRepository.findByUsername("xxminecraftplayerxx")).isNull();
    }

    @Test
    public void whenFindByEmailAndNoUserThenReturnNull() {
        Assertions.assertThat(userRepository.findByEmail("whatis@going.on")).isNull();
    }
}

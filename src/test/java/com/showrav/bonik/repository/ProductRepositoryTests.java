...
import com.showrav.bonik.creator.ProductCreator;
...
public class ProductRepositoryTests {
    ...
    public void whenFindByIdAndNoProductReturnNull(){
        Assertions.assertThat(productRepository.findById(new Random().nextLong())).isNull();
    }

    @Test
    public void whenFindByNameAndNoProductReturnNull(){
        Assertions.assertThat(productRepository.findByName("random string")).isNull();
    }

    @Test
    public void whenFindAllByOrderByIdAscAndNoProductsReturnNull(){
        Assertions.assertThat(productRepository.findAllByOrderByIdAsc()).isNullOrEmpty();
    }
}
